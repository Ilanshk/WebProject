...
describe("Student", () => {
    ...
    test("PUT /student/:id", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(app).put("/student/" + students[1]._id).send({ age: 25 });
        expect(res.statusCode).toBe(200);
    ...
    test("FAIL to PUT student document", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(app).put("/student/" + students[1]._id).send({ age: "AAAA" });
